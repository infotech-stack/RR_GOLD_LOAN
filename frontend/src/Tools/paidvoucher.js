  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${process.env.REACT_APP_BACKEND_URL}/api/paidvouchers/add`,
        formData
      );
      ...
      Swal({
        title: "Success!",
        text: "Paid voucher stored successfully!",
        icon: "success",
        button: "OK",
      });
    ...
    <div ref={componentRef}>
      <div style={{ padding: "20px", marginTop: "80px" }}>
        <Paper
          elevation={2}
          style={{ padding: "20px" }}
          sx={{ maxWidth: 600, margin: "auto", backgroundColor: "#fffcfc" }}
        >
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <Typography
                variant="subtitle1"
                align="center"
                sx={{ fontWeight: 600, mb: 2, color: "#b92020" }}
              >
                PAID VOUCHER
              </Typography>
            </Grid>
              ...
              <Grid item xs={12}>
                <Form.Group controlId="purposeOfAmount">
                  ...
                  <Form.Control
                    ...
                    onChange={handleInputChange}
                    placeholder="Enter Purpose of Amount"
                  />
                </Form.Group>
              </Grid>
